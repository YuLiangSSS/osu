...
namespace osu.Game.Rulesets.Mania.Skinning.Argon
{
    public partial class O2PillBar : PillDisplay, IHasAccentColour, ISerialisableDrawable
    {
        ...
        [SettingSource("Accent Colour")]
        public BindableColour4 ColourAccent { get; } = new BindableColour4(Colour4.White);

        [SettingSource("Glow Colour")]
        public BindableColour4 ColourGlow { get; } = new BindableColour4(Colour4.White);
        ...
        {
            // fill.Colour = ColourOverlay.Value;
            AccentColour = ColourAccent.Value;
        }

        private void updateGlowColour()
        {
            GlowColour = ColourGlow.Value;
        }
        ...
        {
            AccentColour = colours.PinkLighter;
